                            ...
                            <div class="job-summary-sec">
                                <ul class="w-list-items ">
                                 ...
                                 foreach(json_decode($customContent['Records'][0]['attached_files'],true) as $file) {
                                    echo "<p>" . $file['name'] ."</p>";
                                      echo "<p>" . "<a href=" . $file['URL'] . ">" . "<img src='images/pdf-icon.svg'> View </a>" . "</p>";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="comment-desc"><textarea id="comment"
                                            data-id="<?php echo $customContent['Records'][0]['Id']; ?>"><?php echo $customContent['Records'][0]['admin_comment']; ?> </textarea>
                                    </div>
