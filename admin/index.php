                                                ...
                                                <tr v-for="field in allFreelancers" class="border-hover" >
                                                    ...
                                                    <td data-th="Action">
                                                        <div class="btn-accept-reject" v-if="field.status=='Pending'">
                                                            <button class="btn blue-btn" id="accept-button" :data-id="field.Id" onclick="onboardingAccept(this);">Accept</button>
                                                            <button class="btn gre-btn"id="reject-button" :data-id="field.Id" onclick="onboardingReject(this);">Reject</button>
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="payments">
                                <div class="panel-box tabular">
                                    <div class="panel-box subscription-form">
                                        <div class="page-content-top">
                                            <h4>Link your Stripe account to your Marketplace <i class="icon info-blue-icon"></i> <span class="blue-color">How do I connect to Stripe?</span></h4> 
                                            <h5>If you change your live secret keys, all your merchants will have to <span class="color-red">re-onboard</span> to your <span class="color-red">new</span> Subscription account before they can start selling again!</h5>
                                        </div>
                                        <form name="live_secret_key" id="live_secret_key" action="#">
                                            <div class="form-area">
                                                <div class="form-element">
                                                    <label for="live-publishable-key"><span class="red-bold-strong">LIVE</span> PUBLISHABLE KEY</label>
                                                  <input type="text" name="publishable-key" id="live-publishable-key" class="txt required">
                                                </div>
                                                <div class="form-element">
                                                    <label for="live-secret-key"><span class="red-bold-strong">LIVE</span> SECRET KEY</label>
                                                  <input type="text" name="" id="live-secret-key" class="txt required">
                                                </div>
                            
                                                <div class="sync-data">
                            
                                                    <div class="btn-area" id="save-btn"> <a href="javascript:void(0);" class="btn-blue" onclick="MakeUneditable()">Save</a></div>
                                                    <div class="btn-area" id="edit-btn" style="display: none;"><a href="javascript:void(0);" class="btn-blue" onclick="SaveConfirm()">Edit</a></div>
                                                </div>
                                            </div>
                                        </form>
                                </div>
    ...
    <div class="modal-dialog">
       ...
       <div class="modal-content">
          ...
          <div class="modal-footer btn-area">
             ...
             <div><a data-dismiss="modal" href="javascript:void(0)"  class="mybtn btn-blue accept-confirm" v-on:click="updateStatus('Approved', $event)" >Accept</a></div>
          </div>
       </div>
    </div>
 </div>
 ...
 <div id="onboardingReject" class="modal modal-text-area confirmation fade" role="dialog">
    <div class="modal-dialog">
       ...
       <div class="modal-content">
          ...
          <div class="modal-footer btn-area">
             <div><a href="#" class="gre-btn"  data-dismiss="modal">Cancel</a></div>
             <div><a data-dismiss="modal"  href="javascript:void(0)" class="mybtn btn-blue accept-confirm" v-on:click="updateStatus('Rejected', $event)">Reject</a></div>
          </div>
       </div>
    </div>
 </div>
