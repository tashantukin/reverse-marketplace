           ...
           // els1["p"].className = els2["p"].className = els1["p"].value = els2["p"].value = "";
            if (p < 1) p = 1;
                ...
                if (p == "prev") {
                    ...
                    var current = parseInt($(`#${tab}  .page-list`).find('.active').prev('li').attr('value'));
                    var prev = current - 1;
                    p = prev;
                    console.log(`prev ${p}`)
                ...
                if (p == 'next') {
                     var current = parseInt($(`#${tab}  .page-list`).find('.active').next('li').attr('value'));
                     var next = current + 1;
                        p = next;
                        console.log(`next ${p}`)
                }
            ...
            async getAllJobs(action) {
                try {
                    ...
                    $('#job-count').text(vm.totalItemsJobs);
                        ...
                        //     {
                        //         var container = $('#pagination-container-job');
