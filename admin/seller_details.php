        ...
        <div class="popup-demo-content ">
            ...
            <div class="form-group">
                ...
                <select class="form-control required" name="onbrd_field_type" id="onbrd_field_type" :value="fieldType">
                    ...
                    <option value="address-fields">Address Fields</option>
                </select>
            </div>
    ...
    <div class="popup-wrapper">
        ...
        <div class="popup-demo-content">
            ...
            <div class="form-group">
                ...
                <div class="form-input-button-combo">
                    <input type="text" class="form-control required" name="save_button_text" id="freelancer-save-text">
                    <a href="#"  class="blue-btn pull-right" id="freelancer-btn-save-txt">Save</a>
                </div>
