...
if ($jobDetails['Records'][0]['is_time_frame_nohurry'] == 'True') {
    $job_completion = 'No hurry';
}else if ($jobDetails['Records'][0]['is_time_frame_urgent'] == 'True') {
    ...
    <div class="main">
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('body').on('click', '.save-link', function() {
                ...
                if ($input.length > 0) {
                    $(this).closest('.qq-option').html('<span>AUD <b>' + number_format($input.val(),
                            2) +
