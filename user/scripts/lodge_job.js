...
function cache_save_job()
{
    ...
    var job_details = {
        ...
        // "task_type_BAS_Agent": $("#bas_agent")[0].checked,
        // "task_type_Tax": $("#tax")[0].checked,
        // "task_type_Audit": $("#audit")[0].checked,
        // "task_type_bookkeeping": $("#book_keeping")[0].checked,
        // "task_type_Payroll": $("#payroll")[0].checked,
        // "task_type_Finance": $("#finance")[0].checked,
        "time_frame_urgent": $("#urgent")[0].checked,
        "time_frame_nohurry": $("#no_hurry")[0].checked,
        "time_frame_timestamp": $("#datetimepicker").val(),
